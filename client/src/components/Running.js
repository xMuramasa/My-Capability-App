...
export function SpeedScreen() {
	...
	const calculateAvg = (v, a) => {
		...
		Alert.alert('Resultados', 
			"Velocidad Media: " + vx.toString() + " km/h")
	}
	...
	return (
			<View style={ mapStyles.container }>
				...
				<View style={mapStyles.space} />
					...
					<Text style={styles.headerStyle}>Recorrido {"\n"}</Text>
					...
					{
						runStop ?
						<Text style={mapStyles.subLabel}>Velocidad Actual: {()=>{velocidad=velocidad*3.6; velocidad.toFixed(2)}} Km/h</Text>
						:
						<Text style={mapStyles.subLabel}>Inicia un recorrido para saber tu velocidad</Text>
					}
					</View>
			</View>    
		);
