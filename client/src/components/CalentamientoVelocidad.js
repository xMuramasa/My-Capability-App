...
export function CalentamientoVelocidad ({route, navigation}) {
  const [modalVisible, setModalVisible] = useState(true);
  const [modalImages, setModalImages] = useState(2);
              ...
              <View style={styles.rowView}>
                <View>
                    <TouchableOpacity 
                        ...
                        onPress={() => {setModalVisible(!modalVisible),navigation.navigate('TutorialVelocidad')}
                        }
                    >
